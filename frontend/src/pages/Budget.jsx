...
function Budget({ onBudgetUpdated }) {
  ...
  const handleSetBudget = async (e) => {
    ...
    if (selectedYear < currentYear || (selectedYear === currentYear && selectedMonth < currentMonth)) {
      showError("Cannot set budget for past dates. Please select valid month and year.");
      return;
    }
    ...
    try {
      ...
      const errorMsg = err.response?.data?.message || "Failed to check budget";
      showError(errorMsg);
    }
  };
  ...
  return (
    <div className="card">
      ...
      <ConfirmationDialog
        ...
        message="A budget already exists for this month. Do you want to update it?"
